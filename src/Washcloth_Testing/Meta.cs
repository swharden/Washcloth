    ...
    public class Meta_Testing
    {
        ...
        public void Type_ConvertToCsharpSource()
        {
            { // showGenericParameters = false
                (Type, string)[] testCases = new (Type, string)[]
                {
                    ...
                    (typeof(Washcloth_Testing.A.B.C), "Washcloth_Testing.A.B.C"),
                    (typeof(Washcloth_Testing.A.D<System.Int32>.E<System.Int32>), "Washcloth_Testing.A.D<System.Int32>.E<System.Int32>"),
                    (typeof(Washcloth_Testing.A.D<>.E<>), "Washcloth_Testing.A.D<>.E<>"),
                    ...
                    (typeof(Washcloth_Testing.A.D<System.Object>.E<System.String>), "Washcloth_Testing.A.D<System.Object>.E<System.String>"),
                    ...
                    (typeof(StepStatus), "Washcloth.StepStatus"),
                ...
                foreach ((Type, string) testCase in testCases)
                {
                    ...
                    catch
                    {
                        Debugger.Break();
                        temp = testCase.Item1.ConvertToCSharpSource();
                        Assert.IsTrue(temp.Equals(testCase.Item2), testCase.Item1.ToString(), temp);
                    }
                }
            }
            ...
            { // showGenericParameters = true
                (Type, string)[] testCases = new (Type, string)[]
                {
                    ...
                    (typeof(Washcloth_Testing.A.D<>.E<>), "Washcloth_Testing.A.D<AA>.E<BB>"),
                };
                foreach ((Type, string) testCase in testCases)
                {
                    string temp;
        ...
        public void MethodInfo_GetDocumentation()
        {
            foreach (MethodInfo methodInfo in Assembly.GetExecutingAssembly().GetMethodInfosWithAttribute<XmlDocumentationFromMethodAttribute>())
            {
                try
                {
                    string xmlDocumentation = methodInfo.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)methodInfo).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
        ...
        public void Type_GetDocumentation()
        {
            foreach (Type type in Assembly.GetExecutingAssembly().GetTypesWithAttribute<XmlDocumentationFromTypeAttribute>())
            {
                try
                {
                    string xmlDocumentation = type.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)type).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
                    Assert.IsTrue(xmlDocumentation == xmlDocumentationMember);
                }
                catch
        ...
        public void FieldInfo_GetDocumentation()
        {
            foreach (FieldInfo fieldInfo in Assembly.GetExecutingAssembly().GetFieldInfosWithAttribute<XmlDocumentationFromFieldAttribute>())
            {
                try
                {
                    string xmlDocumentation = fieldInfo.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)fieldInfo).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
                    Assert.IsTrue(xmlDocumentation == xmlDocumentationMember);
                }
                catch
        ...
        public void ConstructorInfo_GetDocumentation()
        {
            foreach (ConstructorInfo constructorInfo in Assembly.GetExecutingAssembly().GetConstructorInfosWithAttribute<XmlDocumentationFromConstructorAttribute>())
            {
                try
                {
                    string xmlDocumentation = constructorInfo.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)constructorInfo).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
                    Assert.IsTrue(xmlDocumentation == xmlDocumentationMember);
                }
                catch
        ...
        public void PropertyInfo_GetDocumentation()
        {
            foreach (PropertyInfo propertyInfo in Assembly.GetExecutingAssembly().GetPropertyInfosWithAttribute<XmlDocumentationFromPropertyAttribute>())
            {
                try
                {
                    string xmlDocumentation = propertyInfo.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)propertyInfo).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
                    Assert.IsTrue(xmlDocumentation == xmlDocumentationMember);
                }
                catch
        ...
        public void EventInfo_GetDocumentation()
        {
            foreach (EventInfo eventInfo in Assembly.GetExecutingAssembly().GetEventInfosWithAttribute<XmlDocumentationFromEventAttribute>())
            {
                try
                {
                    string xmlDocumentation = eventInfo.GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));

                    string xmlDocumentationMember = ((MemberInfo)eventInfo).GetDocumentation().xml;
                    Assert.IsTrue(!string.IsNullOrWhiteSpace(xmlDocumentation));
                    Assert.IsTrue(xmlDocumentation == xmlDocumentationMember);
                }
                catch
        ...
        {
            string Test1_a = typeof(XmlDocumentationFromParameter).GetMethod("Test1").GetParameters()[0].GetDocumentation().xml;
